...
function Project(title, pic, about, link) {
    this.title = title;
    this.about = about;
    this.pic = pic;
    this.link = link;
...
const projects = (function (){
   const project1 = new Project('Staffood Restaurant','peoplebg.jpeg', `A simple restaurant page for delicacies`, '')
...
function UpdateProjects(){
   ...
   projectsContainer.textContent = ''
    ...
    projectList.map((item)=>{    
        ...
        projectPic.src = `./${item.pic}`
        projectText.textContent = item.about

        projectHeader.appendChild(projectLink)
        project.appendChild(projectHeader)
        project.appendChild(projectPic)
